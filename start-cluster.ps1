...
Start-Process -FilePath "go" -ArgumentList "run ./cmd/valenced -port 8080 -data-dir ./data/nodeA -peers https://blockchain-simulator-production.up.railway.app" -WindowStyle Normal

Start-Sleep -Seconds 2

Write-Host "Starting Node B on port 8081..."
Start-Process -FilePath "go" -ArgumentList "run ./cmd/valenced -port 8081 -data-dir ./data/nodeB -peers https://blockchain-simulator-production.up.railway.app,localhost:8080" -WindowStyle Normal

Start-Sleep -Seconds 2

Write-Host "Starting Node C on port 8082..."
Start-Process -FilePath "go" -ArgumentList "run ./cmd/valenced -port 8082 -data-dir ./data/nodeC -peers https://blockchain-simulator-production.up.railway.app,localhost:8080" -WindowStyle Normal
